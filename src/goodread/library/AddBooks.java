...
public class AddBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("ADD BOOK INFORMATION");
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        try {
            ...
            if (year == 0 || PubName.isEmpty() || AutName.isEmpty() || title.isEmpty()
                    || id.isEmpty() || Isbn.isEmpty() || Status.isEmpty()
                    || noBooks == 0) {
            ...
            try (Connection connect = DriverManager.getConnection(URL, username, password); PreparedStatement stmt = connect.prepareStatement(query)) {

                stmt.setString(1, id);
                stmt.setString(2, title);
                stmt.setString(3, AutName);
                stmt.setString(4, PubName);
                stmt.setString(5, Isbn);
                stmt.setInt(6, year);
                stmt.setInt(7, noBooks);
            ...
            JOptionPane.showMessageDialog(this, "Please enter valid numeric values for Year and Number of Books.", "Invalid Input", JOptionPane.ERROR_MESSAGE);
